                    ...
                    <div class="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border">
                        <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                            <div class="flex items-center justify-between ">
                                <div>
                                    <h3 class="text-lg font-semibold text-slate-800">Lista de Equipos</h3>
                                    <p class="text-slate-500">Agrega el equipo para tu torneo</p>
                                </div>
                        ...
                        <div class="p-0 overflow-scroll">
                            <table class="w-full mt-4 text-left table-auto min-w-max">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="p-4 border-b border-slate-200" style="display: none;">{{$equipo->id}}</td>
                                        <td class="p-4 border-b border-slate-200">{{ $loop->iteration }}</td>

                                        <td class="p-4 border-b border-slate-200">
                                            <div class="flex items-center gap-3">
                                                <img src="{{ asset('/storage/app/public/imagen/'. $equipo->imagen) }}"
