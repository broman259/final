                                        ...
                                        <td class="p-4 border-b border-slate-200">
                                            <div class="w-max">
                                                <div
                                                    ...
                                                    <span class="">
                                                    {{ \Carbon\Carbon::parse($jornada->created_at)->setTimezone('America/Guatemala')->format('d/m/Y H:i:s') }}
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="p-4 border-b border-slate-200">
                                            <div class="w-max">
                                                <div
                                                    ...
                                                    <span class="">{{ \Carbon\Carbon::parse($jornada->updated_at)->setTimezone('America/Guatemala')->format('d/m/Y H:i:s') }}</span>
                                                </div>
                                            </div>
                                        </td>
